...
import { ADSENSE_DISPLAY_SLOT } from '@/lib/site'
 ...
 * new markup.
 *
 * The single manual ad unit closes the section. It sits outside the article,
 * after every editorial section and before the FAQ heading — a real content
 * break, well clear of the calculator, its controls and the note under the
 * result. Placing it here rather than in the 50 page files is also what keeps
 * it off the category, directory, legal and trust pages, none of which render
 * an article.
 */
export function CalculatorArticle({ content }: CalculatorArticleProps) {
  ...
  return (
    <>
      ...
      <AdUnit slot={ADSENSE_DISPLAY_SLOT} />
    </>
  )
}
